...
<input type=hidden name='sub' value='%sub%'>
  <div class='box box-theme box-big-form'>
    ...
    <div class='box-body'>
      ...
      <div class='form-group'>
        <label class='control-label col-md-3' for='LIVING_SPACE'>_{LIVING_AREA}_</label>
        <div class='col-md-9'>
          <input id='LIVING_SPACE' name='LIVING_SPACE' value='%LIVING_SPACE%' class='form-control' type='text'>
        </div>
      </div>
    </div>
